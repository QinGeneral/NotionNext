...
const BLOG = {
    NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '54b952a6d8ec4fce8f4ecfb09d226430',
    ...
    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Element', // 您的昵称
    BIO: process.env.NEXT_PUBLIC_BIO || '聊聊技术和读书', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://qingeneral.github.io/', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 技术, 读书, AI', // 网站关键词 英文逗号隔开
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址
    CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
    CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/QinGeneral',
    ...
    MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8910779605', // 对应歌单的 id
    ...
    TITLE: process.env.NEXT_PUBLIC_TITLE || 'Element', // 站点标题 ，被notion中的页面标题覆盖
    HOME_BANNER_IMAGE:
